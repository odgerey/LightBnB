...
('Jardin Sec', 'sarah@gmail.com', '$2a$10$FB/BOAVhpuLvpOREQVmvmezD4ED/.JBIDRh70tGevYzYzQgFId2u');
...
(3,'Creepy Mansion', 'Ghosts are sure to haunt you', 'https: //images.pexels.com/photos/2086676/pexels-photo-2086676.jpeg?auto=compress&cs=tinysrgb&h=350', 'https: //images.pexels.com/photos/2086676/pexels-photo-2086676.jpeg', 1200, 5,10,10, 'Transylvania', '400 dracula avenue', 'ChateauCreeps', 'Creeping Charlie', '34566', true);

INSERT INTO reservations(start_date, end_date, property_id, guest_id)
VALUES ('2018-09-11', '2018-09-26', 2, 1),
('2019-01-04', '2019-02-01', 1, 2),
('2017-04-03', '2045-02-01', 3, 3);


INSERT INTO property_reviews (guest_id, property_id, reservation_id, rating, message)
VALUES (2, 1, 2, 3, 'messages'),
(1,2, 1, 5, 'messages'),
(3,3, 3, 4, 'Was terrifying. Not recommended for children under 5');
